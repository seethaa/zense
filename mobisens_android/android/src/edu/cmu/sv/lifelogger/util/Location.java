...
public class Location {
	...
	public Location(double lat, double lng, double alt, float speed){
    ...
    public float distanceTo(Location destination) {
    	...
    	computeDistanceAndBearing(this.getLatitude(), this.getLongitude(),
	...
	public int hashCode(){
		...
		builder.append(this.getLatitude()).append(",").append(this.getLongitude())
		.append(",").append(this.getAltitude());
